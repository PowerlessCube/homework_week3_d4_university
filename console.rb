...
timetable3 = Timetable.new( { 'course_id' => c2.id, 'student_id' => s2.id } )
timetable4 = Timetable.new( { 'course_id' => c3.id, 'student_id' => s3.id } )
timetable5 = Timetable.new( { 'course_id' => c3.id, 'student_id' => s4.id } )
timetable6 = Timetable.new( { 'course_id' => c1.id, 'student_id' => s5.id } )
timetable7 = Timetable.new( { 'course_id' => c3.id, 'student_id' => s6.id } )
timetable8 = Timetable.new( { 'course_id' => c2.id, 'student_id' => s6.id } )
